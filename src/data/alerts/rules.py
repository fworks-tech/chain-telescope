...
DEFAULT_RULES = [
  AlertRule(id="drawdown", description="Primary asset drawdown exceeds threshold", threshold=0.08, confidence="high"),
  AlertRule(id="momentum", description="Primary asset momentum exceeds threshold", threshold=0.05, confidence="medium"),
]
