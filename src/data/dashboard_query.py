...
def load_dashboard_snapshot(time_window: str, watchlist: list[str] | None = None) -> DashboardSnapshot:
  ...
  news_lines = [item.title for item in news_items[:3]] or ["No news items available for the current watchlist."]
